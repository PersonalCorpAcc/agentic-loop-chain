...
This is the `repo-audit` capability of the loop's contract. It audits every configured source root against the repository's rules. It never modifies files, installs dependencies, creates backlog items, pushes or contacts external services.
